...
const DOMElements = {
    ...
    recorderChartCanvas: document.getElementById('recorderChart'),
    recorderSummaryContainer: document.getElementById('recorderSummaryContainer'),
    // สำหรับการจัดเรียง Chart ใน Tab 'ภาค' 'จังหวัด'  และ  'เครื่องบันทึกภาพ'
    ...
    recorderChartSortSelect: document.getElementById('recorderChartSortSelect'),
    // สำหรับปุ่ม View All
    viewAllRegionBtn: document.getElementById('viewAllRegionBtn'),
    viewAllProvinceBtn: document.getElementById('viewAllProvinceBtn'),
    viewAllRecorderBtn: document.getElementById('viewAllRecorderBtn'),
    ...
    tabRecorderBtn: document.getElementById('tabRecorderBtn'),
    ...
    recorderTab: document.getElementById('recorderChartTab'),
    // Controls
...
function showChartTab(tab) {
    ...
    DOMElements.recorderTab.style.display = 'none';
    ...
    DOMElements.tabRecorderBtn.classList.remove('active');
    ...
    switch (tab) {
        ...
        case 'province':
            ...
            break;
        case 'recorder':
            DOMElements.recorderTab.style.display = 'block';
            DOMElements.tabRecorderBtn.classList.add('active');
            // เพิ่มคำสั่งนี้เพื่อบังคับให้กราฟปรับขนาด
            if (recorderChart) recorderChart.resize();
            break;
    }
}
