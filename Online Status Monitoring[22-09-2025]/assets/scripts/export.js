...
function exportExcel(fileName, sortKey = null, sortDirection = 'asc') {
    ...
    try {
        ...
        const headers = [
            'รหัสร้าน', 'ชื่อสาขา', 'ภาค', 'สถานะ', 'สถานะเชื่อมOnline', 'หมายเหตุ', 'เครื่องบันทึกภาพ',
        ...
        const dataToExport = branchesToExport.map(b => [
            Number(b.storeCode), b.branchName, b.region, b.status, b.onlineStatus, b.note, b.recorder,
